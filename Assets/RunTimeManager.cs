...
public class RunTimeManager : MonoBehaviour
{
    ...
    [Header("当前用时显示（可空）")]
    public TMP_Text currentTimeText;      // 实时计时（TextMeshPro）

    [Header("排行榜 5 个 Text（1~5 名）")]
    public TMP_Text[] timeSlots = new TMP_Text[5];   // 这里用 TMP_Text
